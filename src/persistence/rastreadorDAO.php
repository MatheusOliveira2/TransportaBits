<?php
#Classe responsável por comunicar com o banco de dados, com a tabela rastreador.
...
class RastreadorDAO
{
	...
	{ #método responsável por cadastrar rastreadores no banco de dados.
		$cnpj = $_SESSION["cnpj"];
	...
	{ #método responsável por excluir rastreadores no banco de dados.
	...
	{ #método responsável por consultar rastreadores no banco de dados.
	...
	{ #método responsável por alterar informações de rastreadores no banco de dados.
