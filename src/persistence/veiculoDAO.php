	...
	<body>
		<div class="container-fluid">
			<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
				<a class="navbar-brand h1 mb-0" href="#"> Veículo</a>
			</nav>
				...
				<?php
					...
					class VeiculoDAO {
						function cadastrar($veiculo, $link) { #método responsável por cadastrar veículos no banco de dados.
							...
							if(!mysqli_query($link, $query)) die("Erro ao cadastrar! <br /><br /><a  class=\"btn btn-primary\"  href=\"../view/cadastrarVeiculo.php\">VOLTAR</a>") ;
							echo "Veículo Cadastrado com Sucesso.<br /><br /><a  class=\"btn btn-primary\"  href=\"../view/cadastrarVeiculo.php\">VOLTAR</a>";
						}
						...
						function excluir($codigo, $link) { #método responsável por excluir veículos no banco de dados.
							...
							if(!mysqli_query($link, $query)) {
								die("ERRO! Veículo Não Excluido. <br /><br /><a class=\"btn btn-primary\"  href=\"../view/excluirCliente.html\">VOLTAR</a>");
							}
							echo "Veículo Excluído com Sucesso.<br /><br /><a class=\"btn btn-primary\"  href=\"../view/excluirVeiculo.php\">VOLTAR</a>";
						}
						...
						function consultar($codigo, $link) { #método responsável por consultar veículos no banco de dados.
							...
							if(!$result){
								die("ERRO! Veículo Não Encontrado. <br /><br /><a class=\"btn btn-primary\"  href=\"../view/consultarVeiculo.php\">VOLTAR</a>");
							}
							return $result;
						}
						...
						function alterar($placa, $cor,$link) { #método responsável por alterar informações de veículos no banco de dados.
							...
							if(!mysqli_query($link, $query)) {
								die("ERRO! Veículo Não Atualizado.<br /><br /><a class=\"btn btn-primary\"  href=\"../view/atualizarVeiculo.php\">VOLTAR</a>");
							}
							echo "Veículo Atualizado com Sucesso.<br /><br /><a class=\"btn btn-primary\" href=\"../view/atualizarVeiculo.php\">VOLTAR</a>";
					}
