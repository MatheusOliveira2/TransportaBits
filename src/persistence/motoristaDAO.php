<?php
#Classe responsável por comunicar com o banco de dados, com a tabela motorista.
...
class MotoristaDAO
{
	...
	{ #método responsável por cadastrar motoristas no banco de dados.
		$cnpj = $_SESSION["cnpj"];
	...
	{ #método responsável por excluir motoristas no banco de dados.
	...
	{ #método responsável por consultar motoristas no banco de dados.
	...
	{ #método responsável por alterar informações de motoristas no banco de dados.
