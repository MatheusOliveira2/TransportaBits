			...
			<div class="col-sm-12 col-md-12 col-lg-12 text-center">
				...
				<form action="../controller/C_consultarVeiculo.php" method="POST">
					<div class="row d-flex justify-content-center mt-2">
						<div class="col-12" style="text-align: center;margin-right:0px ">N° Série</div>
					</div>
					<div class="row d-flex justify-content-center">
						<div class="col-12 " style="text-align: center;margin-right:8px">
							<select name="nSerie" class="myCombo" style="text-align: center;margin-right:0px">
					...
					<br/>
					<button class="myBtn mr-2" type = "submit"> Consultar </button>
				</form>
			</div>
		</div>
